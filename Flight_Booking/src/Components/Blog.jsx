    ...
    <div className='flex flex-col w-full pb-20 md:px-32 px-8 gap-16 justify-center items-center mt-5'>
      ...
      <div className='flex flex-col w-full text-center items-center'>
        ...
        <p className='text-slate-500 mt-4 max-w-2xl'>
          Lorem ipsum dolor sit amet, consectetur adipisicing elit. Minus aperiam delectus reiciendis amet, debitis natus.
        </p>
      </div>
      ...
      <div className='flex flex-col items-center bg-white p-6 rounded-lg shadow-lg hover:shadow-2xl transition-shadow duration-300'>
        ...
        <p className='text-slate-500 text-center mt-2 px-4'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptate, vero.</p>
      ...
      {/* China Section */}
      <div className='flex flex-col items-center bg-white p-6 rounded-lg shadow-lg hover:shadow-2xl transition-shadow duration-300'>
        <img src={chaina} alt="China" className='w-full h-64 object-cover rounded-lg shadow-md hover:scale-105 transition-transform duration-300' />
        <h1 className='text-slate-700 text-xl font-bold mt-4'>China</h1>
        <p className='text-slate-500 text-center mt-2 px-4'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Expedita, voluptates!</p>
      ...
      <div className='flex flex-col items-center bg-white p-6 rounded-lg shadow-lg hover:shadow-2xl transition-shadow duration-300'>
        ...
        <p className='text-slate-500 text-center mt-2 px-4'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Culpa, minus?</p>
