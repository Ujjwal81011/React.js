        ...
        <div className='bg-black text-white py-20' id='project'>
          <div className='container mx-auto px-8 md:px-16 lg:px-24'>
            ...
            <div className='grid grid-col-1 md:grid-cols-2 lg:grid-cols-3'>
              ...
              <span className='bg-gray-800 rounded-lg px-6 pb-6 hover: shadow-lg transform transition-transform hover:scale-105 duration-300 m-3'>
                <img src={password} alt="" className='rounded-lg' />
                <h2 className='text-center font-bold text-2xl my-4 bg-gradient-to-r from-green-400 to-blue-500 text-transparent bg-clip-text'>Password Generator</h2>
                  <div className='px-4 my-3'>
                    <h3>Using Skills-</h3>
